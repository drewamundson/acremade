...
/******/ 		return __webpack_require__.p + "assets/" + ({"1":"product-image-zoom","2":"squirrelly"}[chunkId]||chunkId) + ".min.js"
/******/ 	}
/******/
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return trapFocus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return removeTrapFocus; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return manageFlickityFocusState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FormStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return markForRefocus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return markForRefocusOnModalClose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return markForRefocusWithin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return refocus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return refocusOnModalClose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return logCascadeFocusError; });
...
/**
 * crawlSiblingsUp, focusFirstElement, trapFocus, removeTrapFocus
 * and focusFirstElement from Alpine’s x-trap directive
 *
 * https://github.com/alpinejs/alpine/blob/main/packages/trap/src/index.js
 *
 */
...
function focusFirstElement(el) {
  ...
  if (autofocus) {
    ...
    var firstFocusable = Array.from(el.querySelectorAll(selector)) // All non-disabled elements...
    .filter(function (el) {
      return !el.hasAttribute('disabled');
    })[0];
    setTimeout(function () {
      return firstFocusable && firstFocusable.focus();
    });
  }
}
...
function trapFocus(el) {
  ...
  undoTrappings.push(function () {
    return activeEl && setTimeout(function () {
      return activeEl.focus();
    });
  });
  crawlSiblingsUp(el, function (sibling) {
    var cache = sibling.hasAttribute('inert');
    sibling.setAttribute('inert', 'inert');
    undoTrappings.push(function () {
      return cache || sibling.removeAttribute('inert');
    });
  });
...
function manageFlickityFocusState($flickity) {
  var $currentSlide = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.is-selected', $flickity);
  $currentSlide.siblings().find(focusableElementsSelector).attr('tabindex', '-1');
  $currentSlide.siblings('[tabindex]').attr('tabindex', '-1');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(focusableElementsSelector, $currentSlide).attr('tabindex', '0');
...
function markForRefocusWithin(container) {
  ...
  if (targetEl) {
    ...
    var selector = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* makeSelectorFromElement */ "c"])(targetEl, [refocusDataAttribute, 'data-qty']);
...
/* unused harmony export filterObjectByValues */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return objectWithDefaults; });
/**
 * Utility helpers
 * -----------------------------------------------------------------------------
...
function filterObjectByValues(object, cb) {
  if (!cb) return object;
...
function objectWithDefaults(defaults, provided) {
  filterObjectByValues(provided, function (value) {
...
/* harmony import */ var _live_region__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17);
...
var ajaxCart = function () {
  ...
  init = function init(options) {
    __webpack_require__.e(/* import() | squirrelly */ 2).then(__webpack_require__.t.bind(null, 92, 7)).then(function (Sqrl) {
      _Sqrl = Sqrl;
  ...
  _init = function _init(options) {
    ...
    adjustCart();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.body).on('ajaxCart.afterCartLoad', function (evt, cart) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-ajax-cart-spinner]').addClass('hide');
    });
  };
  ...
  updateCountPrice = function updateCountPrice(cart) {
    ...
    if ($cartCostSelector) {
      $cartCostSelector.html(Object(_shopify_theme_currency__WEBPACK_IMPORTED_MODULE_1__["formatMoney"])(cart.total_price, settings.moneyWithCurrencyFormat));
    }
  };
  ...
  buildCart = function buildCart(cart) {
    ...
    // is rebuilt
    Object(_tools_a11y__WEBPACK_IMPORTED_MODULE_2__[/* markForRefocusWithin */ "h"])(document.getElementById('CartContainer')); // Show empty cart
    ...
    if (cart.item_count === 0) {
      ...
      Object(_tools_a11y__WEBPACK_IMPORTED_MODULE_2__[/* markForRefocus */ "f"])(document.getElementById('CartLink'));
      cartCallback(cart);
      return;
    ...
    data = {
      items: items,
      note: cart.note,
      totalPrice: Object(_shopify_theme_currency__WEBPACK_IMPORTED_MODULE_1__["formatMoney"])(cart.total_price, settings.moneyWithCurrencyFormat),
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-cart-row]', $cartContainer).length === 0) {
      // if it's empty
      $cartContainer.empty();
      $cartContainer.append(result);
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.get('?sections=additional-checkout-buttons', function (data) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accelerated-checkout-buttons', $cartContainer).append(data['additional-checkout-buttons']);
      });
    } else {
      // if it's already there, update it
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-cart-row]', $cartContainer).remove();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-cart-row]', result).insertBefore(jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-cart-footer]', $cartContainer));

      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#CartSpecialInstructions', $cartContainer)) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#CartSpecialInstructions', $cartContainer).val(data.note);
      }

      jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-subtotal]', $cartContainer).html(jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-subtotal]', result).html());
    }
  ...
  cartCallback = function cartCallback(cart) {
    ...
    Object(_tools_a11y__WEBPACK_IMPORTED_MODULE_2__[/* refocus */ "i"])(); // if (window.Shopify && Shopify.StorefrontExpressButtons) {
  ...
  adjustCart = function adjustCart() {
    ...
    $body.on('click', '.ajaxcart__qty-adjust', function () {
      ...
      if (line) {
        Object(_tools_a11y__WEBPACK_IMPORTED_MODULE_2__[/* markForRefocus */ "f"])($el[0]);
    ...
    $body.on('change', 'textarea[name="note"]', function () {
      var newNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val();
      if (newNote === currentNote) return;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-ajax-cart-spinner]').removeClass('hide'); // Update the cart note in case they don't click update/checkout

      ShopifyAPI.updateCartNote(newNote, function (data) {
        currentNote = data.note;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-ajax-cart-spinner]').addClass('hide');
      });
    });
    $body.on('keyup', 'textarea[name="note"]', debounce(function (e) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).trigger('change');
    }, 750));
  };
  ...
  qtySelectors = function qtySelectors() {
    ...
    var $numInputs = jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="number"]:not(.js-qty__num):not([name*=filter])');
    ...
    if ($numInputs.length) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-qty__adjust').on('click', function () {
        ...
        if ($el.hasClass('js-qty__adjust--plus')) {
          ...
          qty -= 1;
          if (qty <= inputMin) qty = inputMin;
        } // Update the input's number


        $qtySelector.val(qty);
        $qtySelector[0].dispatchEvent(new Event('change', {
          bubbles: true
        }));
      });
    }
  ...
  if (!window.qtySelectors) window.qtySelectors = qtySelectors;
...
window.theme.mobileFlickities = window.theme.mobileFlickities || [];
window.theme.flickities = window.theme.flickities || [];
...
var flickityResizeTimeout;
var savedWidth;

var checkMobileFlickitiesCSS = function checkMobileFlickitiesCSS() {
  var _iterator = _createForOfIteratorHelper(window.theme.mobileFlickities),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var $mobileFlickity = _step.value;
      // Replace the 'watchCSS' method
      // (activate if :after { content: 'flickity' })
      var afterContent = getComputedStyle($mobileFlickity[0], ':after').content;

      if (afterContent.indexOf('flickity') != -1) {
        $mobileFlickity.flickity('activate');
      } else {
        $mobileFlickity.flickity('deactivate');
      }
    }
  } catch (err) {
    _iterator.e(err);
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  checkMobileFlickitiesCSS();
});
window.addEventListener('resize', function (e) {
  if (flickityResizeTimeout) {
    window.cancelAnimationFrame(flickityResizeTimeout);
  }

  flickityResizeTimeout = window.requestAnimationFrame(function () {
    if (window.innerWidth !== savedWidth) {
      var _iterator2 = _createForOfIteratorHelper(window.theme.flickities),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var $flickity = _step2.value;
...
var styles_theme = __webpack_require__(34);
...
var inert_esm = __webpack_require__(35);
...
window.addEventListener('keydown', handleFirstTab);
window.addEventListener('click', handleFirstClick);
// EXTERNAL MODULE: ./src/scripts/vendor/flickity-fix.js
var flickity_fix = __webpack_require__(42);
...
var rte_cjs = __webpack_require__(7);
...
var imagesloaded = __webpack_require__(32);
...
var scrollmonitor_scrollMonitor = __webpack_require__(33);
...
// CONCATENATED MODULE: ./src/scripts/components/cascade.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var cascade_Cascade = /*#__PURE__*/function () {
  function Cascade(element, settings, options) {
    ...
    this.options = Object(utils["d" /* objectWithDefaults */])(defaultOptions, options);
    this.settings = Object(utils["d" /* objectWithDefaults */])(defaultSettings, settings);
    this.init();
  }
  ...
  _createClass(Cascade, [{
    ...
    value: function init() {
      ...
      imagesloaded_default()(this.element, function () {
    ...
    value: function _init() {
      ...
      this.element.querySelectorAll('.item').forEach(function (item) {
        item.classList.add('ready');
      });
      this.masonry = new masonry_default.a(this.element, this.options);
      this.masonry.once('layoutComplete', function () {
        _this2._initObserver();

        if (_this2.settings.onReady) {
          try {
            _this2.settings.onReady();
          } catch (e) {
            console.error(e);
          }
        }

        if (_this2.settings.fadeIn) {
          fade_in(_this2.element);
        }
      });
      this.masonry.layout();
    ...
    value: function _initResize() {
      ...
      var __cascadeResizeHandler = function __cascadeResizeHandler() {
        clearTimeout(_this3.resizeTimerID);
        _this3.resizeTimerID = setTimeout(function () {
          _this3.masonry.layout();
        }, 300);
      };

      this.cascadeResizeHandler = debounce_default()(__cascadeResizeHandler, 300);
      window.addEventListener('resize', this.cascadeResizeHandler);
    }
  }, {
    key: "_initRedraw",
    value: function _initRedraw() {
      var _this4 = this;

      this.redrawTimerID = null;

      var __cascadeRedrawHandler = function __cascadeRedrawHandler(e) {
        var time = e.detail && e.detail.time ? parseInt(e.detail.time, 10) : 300;
        clearTimeout(_this4.redrawTimerID);
        _this4.redrawTimerID = setTimeout(function () {
          _this4.masonry.reloadItems();

          _this4.masonry.layout();
        }, time);
      };

      this.cascadeRedrawHandler = debounce_default()(__cascadeRedrawHandler, 300);
      this.element.addEventListener('cascade:redraw', this.cascadeRedrawHandler);
      this.element.addEventListener('cascade:cascade:redraw', this.cascadeRedrawHandler);
    }
  }, {
    key: "_initObserver",
    value: function _initObserver() {
      ...
      this.childObserver = new MutationObserver(function () {
        _this5.element.dispatchEvent(new CustomEvent('cascade:cascade:redraw'));
      });
      this.childObserver.observe(this.element, {
        childList: true,
        subtree: true
      });
    }
    ...
    value: function deinit() {
      window.removeEventListener('resize', this.cascadeResizeHandler);
...
var CascadingContent = /*#__PURE__*/function (_HTMLElement) {
  _inherits(CascadingContent, _HTMLElement);

  var _super = _createSuper(CascadingContent);

  function CascadingContent() {
    var _this6;

    _classCallCheck(this, CascadingContent);

    _this6 = _super.call(this);
    _this6.settings = {
      defer: _this6.hasAttribute('defer'),
      fadeIn: _this6.hasAttribute('fade-in')
    };
    _this6.options = {
      itemSelector: _this6.getAttribute('item-selector'),
      columnWidth: _this6.getAttribute('column-width'),
      gutter: _this6.getAttribute('gutter'),
      percentPosition: _this6.hasAttribute('percent-position') ? _this6.getAttribute('percent-position') === 'true' : null,
      isLayoutInstant: _this6.hasAttribute('is-layout-instant') ? _this6.getAttribute('is-layout-instant') === 'true' : null,
      originLeft: _this6.hasAttribute('origin-left') ? _this6.getAttribute('origin-left') === 'true' : null
    };
    return _this6;
  }

  _createClass(CascadingContent, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      this.cascade = new cascade_Cascade(this, this.settings, this.options);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      if (this.cascade) this.cascade.deinit();
    }
  }]);

  return CascadingContent;
}( /*#__PURE__*/_wrapNativeSuper(HTMLElement));

function registerCascadeElements() {
  customElements.define('cascading-content', CascadingContent);
}
...
var ajax_cart = __webpack_require__(9);
...
/* harmony default export */ var header = (register('header', {
  ...
  accessibleNav: function accessibleNav() {
    ...
    this.$container.on('click keyup', '[data-desktop-navigation-more-link-trigger]', function (evt) {
      if (evt.which === 13 || evt.type === 'click') {
        Object(a11y["g" /* markForRefocusOnModalClose */])(evt.target);
    ...
    */
    ...
    this.$container.on('keydown', '[data-top-level-item]', function (evt) {
      ...
      try {
        ...
        Object(a11y["d" /* logCascadeFocusError */])(e);
      }
    });
    /**
    ...
    function closeHeader() {
      ...
      headerResize();
      Object(a11y["j" /* refocusOnModalClose */])();
    }
    /**
    ...
    function toggleHeaderClass(method) {
      if (method === 'close') {
        ...
        jquery_default()('button', $navMoreLink).attr('aria-expanded', 'false');
        Object(a11y["k" /* removeTrapFocus */])();
        $header.attr({
          'role': '',
          'aria-modal': 'false'
        });
      ...
      if (method === 'open') {
        ...
        jquery_default()('button', $navMoreLink).attr('aria-expanded', 'true');
        Object(a11y["l" /* trapFocus */])($header[0]);
        $header.attr({
          'role': 'dialog',
          'aria-modal': 'true'
        });
...
var mobile_flickity_mobileFlickity = function mobileFlickity(container) {
  ...
  promise_stylesheet.promiseStylesheet().then(function () {
    $slides.on('ready.flickity', function () {
      Object(a11y["e" /* manageFlickityFocusState */])($slides);
    });
    var flickityInstance = $slides.flickity({
      // options
      freeScroll: true,
      ...
      watchCSS: false,
      resize: false
    }); // Theme Flickities get '.resize()' called on window resize

    window.theme.flickities.push(flickityInstance); // Theme Mobile Flickities get their ':after' content checked on window resize

    window.theme.mobileFlickities.push(flickityInstance);
...
/* harmony default export */ var slideshow = (register('slideshow', {
  ...
  initFlickity: function initFlickity() {
    ...
    window.theme.flickities.push(flickityInstance);
    $button.on("click", function () {
      $slides.flickity("next", true);
    });
    $slides.on('change.flickity', function () {
...
var images_cjs = __webpack_require__(24);
...
var variants_Variants = function () {
  ...
  Variants.prototype = jquery_default.a.extend({}, Variants.prototype, {
    ...
    _updateMasterSelect: function _updateMasterSelect(variant) {
      this.$container[0].querySelectorAll(this.originalSelectorId).forEach(function (input) {
  ...
  StoreAvailability.prototype = Object.assign({}, StoreAvailability.prototype, {
    ...
    fetchContent: function fetchContent(variantId) {
      ...
      return fetch(variantSectionUrl).then(function (response) {
        ...
        if (storeAvailabilityHTML.trim() === '' || storeAvailabilityHTML.indexOf('store-availability-template__container') == -1) {
...
var live_region = __webpack_require__(17);
...
var product_ProductModule = /*#__PURE__*/function () {
  function ProductModule(container) {
    ...
    product_classCallCheck(this, ProductModule);
    ...
    this.selectors = {
      ...
      productBlockContainer: '[data-product-block-container]',
    ...
    this.sectionColor = this.$container.data('section-color');

    if (options.enableProductZoom === true) {
      __webpack_require__.e(/* import() | product-image-zoom */ 1).then(__webpack_require__.bind(null, 95)).then(function (_ref) {
    ...
    jquery_default()(this.selectors.originalSelectorId, this.$container).removeAttr('disabled'); // variant events
    ...
    if (this.$container[0].dataset.split === 'true') {
      promise_stylesheet.promiseStylesheet().then(function () {
        _this._splitDescription(jquery_default()('[data-product-description]', _this.$container));
      });
    }
  ...
  product_createClass(ProductModule, [{
    key: "_setUpModaalForLink",
    value: function _setUpModaalForLink($el) {
      var accessible_title = $el.attr('data-modaal-accessible-title');
      $el.modaal({
        type: 'inline',
        accessible_title: accessible_title,
        before_open: function before_open(e) {
          Object(a11y["g" /* markForRefocusOnModalClose */])(e.target);
        },
        after_open: function after_open($modaalWrapper) {
          Object(a11y["l" /* trapFocus */])($modaalWrapper[0]);
        },
        after_close: function after_close() {
          Object(a11y["k" /* removeTrapFocus */])();
          Object(a11y["j" /* refocusOnModalClose */])();
    ...
    value: function updateVariantStoreAvailability(variant) {
      ...
      if (variant && variant.available) {
        ...
        this.storeAvailability.fetchContent(variant.id).then(function (storeAvailabilityData) {
          ...
          var self = _this2;
          jquery_default()('[data-store-pickup-availability-modaal]', _this2.$storeAvailabilityContainer).each(function () {
            self._setUpModaalForLink(jquery_default()(this));
          });
    ...
    value: function _setUpImageZoom(PhotoSwipe, PhotoSwipeUI_Default) {
      ...
      jquery_default()(this.selectors.productMediaTypeImage).on('click imageZoom', function (e) {
        ...
        if (triggeringEl) {
          Object(a11y["g" /* markForRefocusOnModalClose */])(triggeringEl);
        }
    ...
    value: function _openZoomModal(PhotoSwipe, pswpElement, PhotoSwipeUI, items, options, triggeringEl) {
      ...
      gallery.init();
      Object(a11y["l" /* trapFocus */])(pswpElement);
      jquery_default()('html, body').addClass('overflow--hidden');
    ...
    value: function _updateProductPrices(evt) {
      ...
      var formattedNewPrice;
      var switchablePriceFormatter = theme.data.currencyCodeEnable ? theme.moneyWithCurrencyFormat : theme.moneyFormat;
      jquery_default()(this.selectors.productPrice, this.$container).html(Object(currency_cjs["formatMoney"])(variant.price, switchablePriceFormatter));
      ...
      if (variant.unit_price) {
        ...
        jquery_default()(this.selectors.productBlockContainer, this.$container).addClass('has-unit-price');
      } else {
        jquery_default()(this.selectors.productBlockContainer, this.$container).removeClass('has-unit-price');
      }

      if (variant.compare_at_price > variant.price) {
        jquery_default()(this.selectors.productPrice, this.$container).addClass("color--".concat(this.sectionColor, "-accent"));
        jquery_default()(this.selectors.unitPriceWrapper, this.$container).addClass("color--".concat(this.sectionColor, "-accent"));
        $comparePrice.html(Object(currency_cjs["formatMoney"])(variant.compare_at_price, switchablePriceFormatter));
        $compareEls.removeClass('hide');
      } else {
        jquery_default()(this.selectors.productPrice, this.$container).removeClass("color--".concat(this.sectionColor, "-accent"));
        jquery_default()(this.selectors.unitPriceWrapper, this.$container).removeClass("color--".concat(this.sectionColor, "-accent"));
        $comparePrice.html('');
    ...
    value: function _splitDescription(productDescription) {
      ...
      var $imageElement = "<div class=\"item item--large-gap item--desktop--half item--mobile--full".concat(fadeIn ? ' fade-in' : '', "\"><div class=\"item__inner\"></div></div>");
      var $contentElement = "<div class=\"item item--large-gap item--desktop--half item--mobile--full".concat(fadeIn ? ' fade-in' : '', "\"><div class=\"item__inner lg--up--text-align--center\"><div class=\"pm--three-quarters wd--two-thirds inline-block text-align--left\"></div></div></div>"); // first unwrap div tags as they cause issues
      ...
      var textnodes = this._getTextNodesIn($productDescription[0]);
      ...
      if (canSplit) {
        ...
        this.cascade = new cascade_Cascade($productDescription[0], {
          onReady: function onReady() {
            $productDescription[0].classList.remove('visibility--hidden--js-only');
          }
        });
      } else {
        $productDescription.removeClass('visibility--hidden--js-only');
    ...
    key: "_initModaal",
    value: function _initModaal() {
      var self = this;
      jquery_default()('[data-product-popup-modaal]').each(function () {
        self._setUpModaalForLink(jquery_default()(this));
      });
    }
  }, {
...
/* harmony default export */ var cascade = (register('cascade', {
  onLoad: function onLoad() {
    var _this = this;
...
/* harmony default export */ var collection = (register('collection', {
  onLoad: function onLoad() {
    ...
    this.changeView(); // Shopify.queryParams = {};
...
var js_cookie = __webpack_require__(18);
